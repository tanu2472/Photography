  ...
  return (
    <div className="bg-gray-900 text-white py-4 text-center">
        ...
        <div className="flex justify-center space-x-4 mt-2">
          <a href="https://www.facebook.com/lensaura" className="text-gray-400 hover:text-white transition">
            <img src="src/assets/facebook.png" alt="Facebook" className="w-5 h-5" />
          </a>
          <a href="https://www.instagram.com/lensaura" className="text-gray-400 hover:text-white transition">
          <img src="src/assets/instagram.png" alt="Instagram" className="w-5 h-5" />
          </a>
          <a href="https://www.youtube.com/lensaura" className="text-gray-400 hover:text-white transition"> 
