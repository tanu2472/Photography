  ...
  return (
    <div className="gallery min-h-screen py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <img src="https://tse4.mm.bing.net/th/id/OIP.ff-wKYvuPCHTHeYLTJi09wHaJQ?pid=ImgDet&w=474&h=592&rs=1&o=7&rm=3" alt="Gallery Image 6" className="w-full h-95 md:h-80 object-cover rounded-lg shadow-lg" />
            ...
            <img src='https://s.studiobinder.com/wp-content/uploads/2021/04/Event-photography-examples.jpg?resolution=2560,1' alt ="Gallery Image 7" className="w-full h-95 md:h-80 object-cover rounded-lg shadow-lg" />
            <img src="https://www.photo8.co.uk/wp-content/uploads/2020/01/Birmingham-event-photographer.jpg" alt="Gallery Image 8" className="w-full h-95 md:h-80 object-cover rounded-lg shadow-lg" />
        </div>
    </div>
  )
}
