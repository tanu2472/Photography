        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <img
              ...
              alt="Studio"
              className="md:w-full h-48 object-cover rounded-lg mb-4"
            />
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <img
              src="src/assets/contact-information.png"
              alt="Contact"
              className="md:w-full h-48 object-cover rounded-lg mb-4"
            />
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="https://www.instagram.com/lensaura"
                target="_blank"
              ...
              <a
                href="https://www.youtube.com/lensaura"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-2 bg-white rounded hover:bg-gray-50"
              >
              ...
              <a
                href="https://www.facebook.com/lensaura"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-2 bg-white rounded hover:bg-gray-50"
              >
